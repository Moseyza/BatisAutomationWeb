...
import FoldersTreeNode from '@/components/Cartable/FoldersTree/FoldersTreeNode/FoldersTreeNode.vue';
...
import AttachmentEditor from '@/components/Cartable/AttachmentEditor/AttachmentEditor.vue';

import store from '@/store';
import { AutoCompleteData } from '@/store/models/Letter/AutoCompleteData';
@Component({
    components: {LetterTrailTree, FoldersTreeNode, AttachmentEditor}
})
