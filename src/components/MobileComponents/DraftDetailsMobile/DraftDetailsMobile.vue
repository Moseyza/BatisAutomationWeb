            ...
            <div style="height: 100%">
                ...
                <div>
                    <div class="symmetric-grid" style="margin-bottom: 5px">
                        ...
                        <div style="flex:10">
                            <RecipientLookupMobile :recipients="recipients" @recipient-selected="selectRecipient($event, 'draft')" />
                        </div>
                    </div>
                    <div class="symmetric-grid">
                        <div style="flex:1"></div>
                        <FastSendRecipientSelectorMobile style="flex:10" :autoCompleteDataType="'draft'" :recipients="selectedDraftRecipients" @recipient-removed="onRecipientRemoved($event,'draft')" />
                    </div>
                    <div class="symmetric-grid" style="margin-bottom: 5px">
                        <div style="flex:1;margin-left:5px">
                            اصلی
                        ...
                        <div style="flex:10">
                            <RecipientLookupMobile :recipients="recipients" @recipient-selected="selectRecipient($event,'main')" />
                        </div>
                    </div>
                    <div class="symmetric-grid">
                        <div style="flex:1"></div>
                        <FastSendRecipientSelectorMobile style="flex:10" :autoCompleteDataType="'all'" :recipients="selectedMainRecipients" @recipient-removed="onRecipientRemoved($event,'main')" />
                    </div>
                    <div class="symmetric-grid" style="margin-bottom: 5px">
                        ...
                        <div style="flex:10">
                            <RecipientLookupMobile :recipients="recipients" @recipient-selected="selectRecipient($event,'copy')" />
                        </div>
                    </div>
                    <div class="symmetric-grid">
                        <div style="flex:1"></div>
                        <FastSendRecipientSelectorMobile style="flex:10" :autoCompleteDataType="'copy'" :recipients="selectedCopyRecipients" @recipient-removed="onRecipientRemoved($event,'copy')" />
                    </div>
                </div>
                <div class="symmetric-grid" style="margin-bottom: 5px">
                    <div style="flex:1;margin-left:5px">
                    ...
                    <div style="flex:10; width:100%;min-height: 26px;padding-top:3px; border-radius:5px" class="bg1">
                        <PrioritySelectorMobile @priority-changed="onPriorityChanged($event)" :priority="letter.priority" />
                    </div>
                </div>
                <div class="symmetric-grid" style="margin-bottom: 5px">
                    <div style="flex:1;margin-left:5px">
                    ...
                    <div style="flex:10; display:flex; width:100%;border-radius:5px;background-color:transparent;">
                        <div style="display:flex;flex-direction:column; width:100%">
                            <DependentItemMobile :letter="item" v-for="(item,index) in dependentLetters" :key="index" />
                        </div>
                    </div>
                </div>
                <div class="symmetric-grid" style="margin-bottom: 5px">
                    ...
                    <div style="flex:10; display:flex; width:100%;border-radius:5px;background-color:transparent;">
                        <div style="flex:5;justify-content:flex-start;flex-wrap:wrap" class="symmetric-grid">
                            <LetterAttachmentMobile v-for="(file,index) in attachments" :key="index" :canRemove=true :file="file" :index="index" @remove="onAttachmentRemoved($event)" style="margin:2px" />
                        </div>
...
import PrioritySelectorMobile from '@/components/MobileComponents/FastSendMobile/PrioritySelectorMobile/PrioritySelectorMobile.vue';
...
@Component({
    name: "DraftDetails",
    components: { LetterAttachmentMobile, LetterTrailTreeMobile, RecipientLookupMobile, FastSendRecipientSelectorMobile , PrioritySelectorMobile, FileSelector, FullPageLoader, MessageBox, FullPageTrail,InPlaceMessageBox, InPlaceSendingOptionsMobile}
})
export default class DraftDetailsMobile extends Vue {
