<template>
    <div class="three-part-flexbox">
       ...
       <div class="flex-part-middle" >
            گیرنده اصلی:
           <RecipientLookupMobile v-if="shallShowMainLookup" :recipients="recipients" @recipient-selected="selectMainRecipient($event)"/>
           <RecipientSelectorMobile  @additem-requested="onAddRecipientRequest('main')" :autoCompleteDataType="'all'" :recipients="selectedMainRecipients" 
           @recipient-removed="onMainRecipientRemoved($event)"
           />

            گیرنده رونوشت:
           <RecipientLookupMobile v-if="shallShowCopyLookup" :recipients="recipients" @recipient-selected="selectCopyRecipient($event)"/>
           <RecipientSelectorMobile @additem-requested="onAddRecipientRequest('copy')" :autoCompleteDataType="'copy'" :recipients="selectedCopyRecipients" 
...
import RecipientSelectorMobile from './RecipientSelectorMobile/RecipientSelectorMobile.vue';
...
import RecipientLookupMobile from './RecipientLookupMobile/RecipientLookupMobile.vue';
...
@Component({
    components: {RecipientSelectorMobile, ToggleSwitch, RecipientLookupMobile, LetterAttachmentMobile,InPlaceMessageBox , FullPageLoader}
})
export default class ForwardLetterMobile extends Vue{
