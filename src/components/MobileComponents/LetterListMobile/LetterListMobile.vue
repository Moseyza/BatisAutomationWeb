<template>
    <div class="three-part-flexbox">
        ...
        <div style="display:flex; flex-direction:column; flex: 0 1 auto;"  class="flex-part-bottom">
            <LetterTypeSelectorMobile  v-if="mode !== '' && mode !== undefined" :mode="mode" @letter-type-changed="onLetterTypeChanged($event)" style="align-items: stretch;" :counts="counts" ref="typeSelector" ></LetterTypeSelectorMobile>
        </div>
    </div>
</template>
...
import SingleLetterMobile from './SingleLetterMobile/SingleLetterMobile.vue'
import * as api from '@/store/api'
import {Letter} from '@/store/models/Letter/Letter'
import { getNewGuid } from '@/util/utils';
import LetterFilterMobile from './LetterFilterMobile/LetterFilterMobile.vue';
import LetterSearchMobile from './LetterSearchMobile/LetterSearchMobile.vue';
import LetterTypeSelectorMobile from './LetterTypeSelectorMobile/LetterTypeSelectorMobile.vue';
...
import SearchResultItemMobile  from '@/components/MobileComponents/SearchResultListMobile/SearchResultItemMobile/SearchResultItemMobile.vue';
import * as letterService from '@/store/Services/letterServices';
import { DraftLetter } from '../../../store/models/Letter/DraftLetter';

@Component({
    components:{SingleLetterMobile,SearchResultItemMobile, LetterFilterMobile, LetterSearchMobile,LetterTypeSelectorMobile}
})
export default class LetterListMobile extends Vue{
