<template>
    <div style="display: flex;flex-direction: column;overflow: auto;max-height: 20em;">
        <div class="fields-row"> 
                ...
                <div class="search-field-value"><LetterOwnerLookupMobile  :index=4 :selectedValueProp="cartableOwnerId" :letterOwnersProp="allLetterOwners" @letterowner-selected="onLetterOwnerSelected($event,'cartable')" :style="{'pointer-events': canSeeAllLetters?'unset':'none'}" /></div>
        </div>
        <div class="fields-row"> 
                ...
                <div class="search-field-value"><LetterOwnerLookupMobile :index=1 :selectedValueProp="presentInId" :letterOwnersProp="allLetterOwners" @letterowner-selected="onLetterOwnerSelected($event,'present')" /></div>
        </div>
        <div class="fields-row"> 
                ...
                <div class="search-field-value"> <LetterOwnerLookupMobile :index=2 :selectedValueProp="fromOwnerId" :letterOwnersProp="allLetterOwners" @letterowner-selected="onLetterOwnerSelected($event,'from')" /> </div>
        </div>
        <div class="fields-row"> 
                ...
                <div class="search-field-value"> <LetterOwnerLookupMobile :index=3 :selectedValueProp="toOwnerId" :letterOwnersProp="allLetterOwners" @letterowner-selected="onLetterOwnerSelected($event,'to')" /></div>
        </div>
        <div class="fields-row"> 
...
import LetterOwnerLookupMobile from './LetterOwnerLookupMobile/LetterOwnerLookupMobile.vue';
...
@Component({
        components: {TriStateCheckbox, PrioritySelector, LetterOwnerLookupMobile, VuePersianDatetimePicker}
})
export default class AdvancedSerachMobile extends Vue
{       
