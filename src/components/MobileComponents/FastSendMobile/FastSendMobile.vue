    ...
    <div class="three-part-flexbox">
        ...
        <div class="flex-part-middle" style="flex:7">
            ...
            <div v-if="mode=='draft'" class="symmetric-grid" style="margin-bottom: 5px">
                ...
                <div style="flex:10">
                    <RecipientLookupMobile  v-if="shallShowDraftLookup"  :recipients="recipients" @recipient-selected="selectRecipient($event, 'draft')"   />    
                    <FastSendRecipientSelectorMobile style="flex:10;flex-wrap: wrap;"  :autoCompleteDataType="'draft'" :recipients="selectedDraftRecipients" @recipient-removed="onRecipientRemoved($event,'draft')"   @additem-requested="onAddRecipientRequest('draft')"  />
                </div>
            </div>
            <div v-if="mode=='send'" class="symmetric-grid" style="margin-bottom: 5px">
                ...
                <div style="flex:10">
                    <RecipientLookupMobile v-if="shallShowMainLookup"  :recipients="recipients" @recipient-selected="selectRecipient($event,'main')"   />    
                    <FastSendRecipientSelectorMobile  style="flex:10;flex-wrap: wrap;" :autoCompleteDataType="'all'" :recipients="selectedMainRecipients" @recipient-removed="onRecipientRemoved($event,'main')"   @additem-requested="onAddRecipientRequest('main')" />
                </div>
            </div>
            <div v-if="mode=='send'" class="symmetric-grid" style="margin-bottom: 5px">
                <div style="flex:1;margin-left:5px">
                ...
                <div style="flex:10">
                    <RecipientLookupMobile   v-if="shallShowCopyLookup" :recipients="recipients" @recipient-selected="selectRecipient($event,'copy')"   />    
                    <FastSendRecipientSelectorMobile style="flex:10;flex-wrap: wrap;" :autoCompleteDataType="'copy'"  :recipients="selectedCopyRecipients" @recipient-removed="onRecipientRemoved($event,'copy')"   @additem-requested="onAddRecipientRequest('copy')" />
                </div>
            </div>
            ...
            <div class="symmetric-grid" style="margin-bottom: 5px">
                ...
                <div style="flex:10; width:100%;min-height: 26px;padding-top:3px; border-radius:5px" class="bg1" >
                    <PrioritySelectorMobile @priority-changed="onPriorityChanged($event)"/>
                </div>
            </div>
        ...
        <div class="flex-part-bottom container1" style="flex:0 1 auto; margin-left:0">
            ...
            />
            <InPlaceSendingOptionsMobile   v-else-if="shallShowSendingOptions" @close="onSendingOptionsClosed()" @toggle-options="toggleSendOption($event)" :setCopyProp="shallSetCopyReceivers" :signProp="shallSign"/>
...
import PrioritySelectorMobile from './PrioritySelectorMobile/PrioritySelectorMobile.vue';
import { LetterOwnerEmail } from '@/store/models/LetterOwner/LetterOwnerEmail';
import { Letter } from '../../../store/models/Letter/Letter';
import DependentItemMobile from './DependentItemMobile/DependentItemMobile.vue';
...
import InPlaceSendingOptionsMobile from '@/components/MobileComponents/FastSendMobile/InPlaceSendingOptionsMobile.vue';

@Component({
    components:{RecipientLookupMobile, FastSendRecipientSelectorMobile, MessageBox, FileSelector, LetterAttachmentMobile, FullPageLoader, InPlaceMessageBox,PrioritySelectorMobile , DependentItemMobile, InPlaceSendingOptionsMobile}
})
export default class FastSentMobile extends Vue{
