...
@Component({
    name:"FastSendSelectedRecipientMobile",
    components: { LetterAttachmentMobile, FileSelector, RecipientLookupMobile, CommentEditorMobile }
})
export default class FastSendSelectedRecipientMobile extends Vue{
