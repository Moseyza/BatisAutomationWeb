...
@Component({
    name:'FoldersTreeNodeMobile'
})
export default class FoldersTreeNodeMobile extends Vue {
    @Prop() data?: FoldersTreeNodeDataMobile;
...
export interface FoldersTreeNodeDataMobile {
    isRoot: boolean;
    name: string;
    id: string;
    iconClass: any;
    url: string;
    children: FoldersTreeNodeDataMobile[];
    isSelected: boolean;
}
